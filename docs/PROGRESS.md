...
- [x] LLM-backed AI summaries: `internal/ai/llm.go` with OpenAI
...
| 8 | [x] LLM-backed AI summaries (`internal/ai/llm.go` + OpenAI) | `TestLLMSummaryFallsBackToScaffold` unit test |
